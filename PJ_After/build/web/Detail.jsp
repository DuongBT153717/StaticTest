<%-- 
    Document   : Detail
    Created on : Feb 15, 2022, 3:30:19 AM
    Author     : Admin
--%>
                        ...
                        <div class="col-sm-9 padding-right">
                            ...
                            <div class="col-sm-7">
                                <div class="product-information"><!--/product-information-->
                                    ...
                                    <span>
                                        <span>US $${dt.price}</span>
                                        <label>Quantity:</label>
                                        <input type="text" value="${dt.quantity}" /><br>

                                    </span>
                                    <h3 style="font-weight: bold">Description</h3><br>
                                    <ul style="padding: 0px;list-style-type: circle">
                                        <c:forEach var="o" items="${infor}">
                                            <li class="mb-1">
                                                <p>${o}</p>
                                            </li>
                                        </c:forEach>
                        ...
                        <div class="recommended_items">
                            ...
                            <div id="recommended-item-carousel" class="carousel slide" data-ride="carousel">
                                <div class="carousel-inner">
                                    <c:forEach items="${listProbyCat}" var="c">
