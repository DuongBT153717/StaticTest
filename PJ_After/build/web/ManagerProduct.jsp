            ...
            <div class="table-wrapper">
                <div class="table-title">
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <!--data-toggle="modal"-->
                            <a class="btn btn-success"  href="addnew"><i class="material-icons">&#xE147;</i> <span >Add New Product</span></a>
                ...
                <table class="table table-striped table-hover">
                    ...
                    <div class="clearfix">
                        <div class="hint-text">Your storage have <b>${count}</b> products</div>
                        <ul class="pagination">
                            <c:if test="${page>1}">
                                <li class="page-item"><a href="manager-product?page=${page-1}">Previous</a></li>
                                </c:if>
                                <c:forEach begin="1" end="${endPage}" var="i">
                                <li class="page-item ${i==page?"active":""}"><a href="manager-product?page=${i}" class="page-link">${i}</a></li>
                                </c:forEach>
