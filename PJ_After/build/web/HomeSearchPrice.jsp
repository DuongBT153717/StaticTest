                        ...
                        <c:choose>
                            ...
                            <c:otherwise>
                                <nav aria-label="Page navigation example">
                                    <ul class="pagination">
                                        <c:if test="${page>1}">
                                            <li class="page-item"><a class="page-link" href="search-price?page=${page-1}">Previous</a></li>
                                            </c:if>

                                        <c:forEach begin="1" end="${endPage}" var="i">
                                            <li class="page-item ${i==page?"active":""}"><a class="page-link" href="search-price?page=${i}&min=${min}&max=${max}">${i}</a></li>
                                            </c:forEach>
                         
                                        <c:if test="${page<endPage}">
                                            <li class="page-item"><a class="page-link" href="search-price?page=${page+1}">Next</a></li>
                                            </c:if>
                                    </ul>
                                </nav>
                            </c:otherwise>
