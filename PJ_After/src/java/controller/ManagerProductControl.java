...
public class ManagerProductControl extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Product> listProductwithPagging = dao.pagingManagerProduct(index, acc.getIduser()); //Truyền vào id của account

        int count = dao.countProductBySeller(acc.getIduser());
        int endPage = count / 6;
        if (count % 6 != 0) {
