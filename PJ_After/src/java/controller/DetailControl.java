...
public class DetailControl extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        int idraw =Integer.parseInt(request.getParameter("pid"));
        ...
        Product p=pd.getProductById(idraw);
        List<Product> listProbyCat = pd.getTop3ListProByCat(cid,idraw);
        ...
        request.getSession().setAttribute("UrlHistory", "detail?productId="+idraw);
